...
\begin{itemize}
	...
	\item \code{PROFILE}: (used in rule \code{make profile}) it simply sets a flag that does not allow thread sticking, since this interferes with the profiling process.
\end{itemize}
